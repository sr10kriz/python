...
# type-2 -> import calculation.calCulations - this also address the same directory = /calculation/calCulations.py - this applicable for only if you are in a differenct directory or root directory
...
# type-4 -> from calculation import calCulations as myMaths
